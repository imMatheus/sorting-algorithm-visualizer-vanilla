...
getSticks()
document.getElementById('burnOutRangeLabel').innerText =
    'Speed: ' + document.getElementById('burnOutRange').value + 'ms'
document.getElementById('sticksRangeLabel').innerText =
    'Sticks: ' + document.getElementById('sticksRange').value
